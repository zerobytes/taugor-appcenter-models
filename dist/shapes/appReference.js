...
/*#__PURE__*/
function (_ShapeBase) {
  _inherits(AppReference, _ShapeBase);
  ...
  function AppReference() {
    ...
    _classCallCheck(this, AppReference);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(AppReference).call(this, data));
    _this.uid = '';
    _this.code = '';
    _this.$fieldConfig = {
      uid: {
