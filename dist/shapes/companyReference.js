...
/*#__PURE__*/
function (_ShapeBase) {
  _inherits(CompanyReference, _ShapeBase);
  ...
  function CompanyReference() {
    ...
    _classCallCheck(this, CompanyReference);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CompanyReference).call(this, data));
    _this.uid = '';
    _this.code = '';
    _this.$fieldConfig = {
      uid: {
        ...
        validate: function validate() {
          return validator(_assertThisInitialized(_this), 'uid').isOfType().notEmpty().notNull().isValid();
        }
      },
      code: {
        type: FieldTypes.String,
